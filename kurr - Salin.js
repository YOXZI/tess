...
_🐬 ${prefix}othermenu_
 `
sendButLocation(from, `${menu}`, "*_© KurrXdゑ v.3.0_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`owner`,buttonText:{displayText:'PEMILIK BOT'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'makermenu':
  if (!isRegistered) return reply(`daftar dlu om ketik .verify`)
     ...
     get_result = ini_result.result
       ...
       menu = `*─❒ MAKER MENU*
_🐬 ${prefix}terbaikmaker (teks/teks2)_
_🐬 ${prefix}bengekmaker (teks/teks2)_
_🐬 ${prefix}memekertas (teks)_
_🐬 ${prefix}shadow (teks)_
_🐬 ${prefix}banner (teks)_
_🐬 ${prefix}flaming (teks)_
_🐬 ${prefix}rainbow (teks)_
_🐬 ${prefix}smoke (teks)_
_🐬 ${prefix}love (teks)_
_🐬 ${prefix}wood (teks)_
_🐬 ${prefix}stars (teks)_
_🐬 ${prefix}coffee (teks)_
_🐬 ${prefix}butterfly (teks)_
_🐬 ${prefix}summer (teks)_
_🐬 ${prefix}candy (teks)_
_🐬 ${prefix}royal (teks)_
_🐬 ${prefix}paper (teks)_
_🐬 ${prefix}fur (teks)_
_🐬 ${prefix}joker (teks)_
_🐬 ${prefix}blackpink (teks)_
_🐬 ${prefix}neon (teks)_
_🐬 ${prefix}devil (teks)_
_🐬 ${prefix}matrix (teks)_
_🐬 ${prefix}transformers (teks)_
_🐬 ${prefix}thunder (teks)_
_🐬 ${prefix}harry (teks)_
...
_🐬 ${prefix}tomp4 [ _reply sticker gif_ ]_
...
break
        case 'store':
gifnya = await getBuffer('https://telegra.ph/file/150734ff875702094d8ca.mp4')
...
break
 ...
 `
sendButLocation(from, `${menu}`, "*_© KurrXdゑ v.3.0_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`owner`,buttonText:{displayText:'PEMILIK BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
